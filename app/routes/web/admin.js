...
const ticketController = require('app/http/controllers/admin/TicketController');
...
router.get('/response/:id', ticketController.response);
router.post('/response/send', ticketController.Sendresponse);
...
// router.get('/comments/approved', gate.can('comment'), commentController.approved);
// router.get('/comments', gate.can('comment'), commentController.index);
